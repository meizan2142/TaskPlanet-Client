        ...
        <div className="mx-auto my-52 w-full max-w-md space-y-8 rounded-lg border bg-white p-7 shadow-xl mobile:p-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div className="space-y-2 text-sm ">
                    ...
                    <input
                        className="flex h-10 w-full rounded-md text-black border px-3 py-2 text-sm focus:ring-1 focus-visible:outline-none bg-white"
                        id="username"
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <input
                        className="flex h-10 w-full rounded-md border px-3 py-2 text-sm focus:ring-1 text-black focus-visible:outline-none bg-white"
                        id="password"
